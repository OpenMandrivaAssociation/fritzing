...
%setup -q -T -D -n fritzing-app-develop -a 1
%setup -q -T -D -n fritzing-app-develop -a 2
%setup -q -T -D -n fritzing-app-develop -a 3
%setup -q -T -D -n fritzing-app-develop -a 4
